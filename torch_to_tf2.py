...
import torchfile
from tensorflow.keras.layers import Input, MaxPool2D, UpSampling2D, Activation, ZeroPadding2D, Add
...
def getr(tobj, ln):
    for module in tobj['modules']:
        if ln == 0:
            return module, 0
        ln -= 1
        if b'modules' in module.__dir__():
...
if __name__ == "__main__":
    ...
    model.save('vrn-unguided-tf2.h5')